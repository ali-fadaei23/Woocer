...
// ad animation to header terms section when in view
  ...
  return (
    <Container className="privacy-container">
      <Row style={{ flexDirection: "column" }}>
        <div className="section-header-privacy-policy">
          ...
          <div className="layer-image">
            <span
              className={
                animationStart
                  ? "layer-privacy-policy-1 animation-layer-privacy-policy-1"
                  : "layer-privacy-policy-1"
              }
            ></span>
            <span
              className={
                animationStart
                  ? "layer-privacy-policy-2 animation-layer-privacy-policy-2"
                  : "layer-privacy-policy-2"
              }
            ></span>
          </div>
          ...
          <div className="box-title-privacy-policy">
            <div className="title-privacy-policy">
              <h1 className="text-title">Privacy Policy - Woocer</h1>
              <div className="box-links-privacy-policy">
                <div className="links-privacy-policy">
                  <li className="li-home li-style">
                    <a href="/" className="link-home-privacy-policy">
                      Home
                    </a>
                  </li>
                  <li className="li-privacy-policy li-style">
